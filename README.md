...
`workerbee-phone-onboarding` 会帮你定位卡在哪一步，并给出只需在手机上完成的操作。

## 五个技能

| 技能 | 什么时候自动触发 | 门槛 |
|---|---|---|
| `workerbee-phone-onboarding` | 新安卓手机首次连接、组件安装失败、真机自检未通过 | 工蜂桌面软件 + USB 数据线 |
...
v1.3.0 · 2026-08-17（新增安卓手机首次连接诊断与真机自检）
